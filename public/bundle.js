...
/* harmony export (immutable) */ __webpack_exports__["drawHeatMap"] = drawHeatMap;
/* harmony export (immutable) */ __webpack_exports__["drawTreeMap"] = drawTreeMap;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__scatter__ = __webpack_require__(586);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__show_heatmap_js__ = __webpack_require__(587);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__treemap__ = __webpack_require__(588);
...
document.addEventListener('DOMContentLoaded', () => {
    Object(__WEBPACK_IMPORTED_MODULE_3__show_heatmap_js__["a" /* showHeatMap */])();
    drawHeatMap();
    drawTreeMap();
});
...
function drawHeatMap() {
    ...
    let svg = __WEBPACK_IMPORTED_MODULE_1_d3__["a" /* select */](".heat-map-modal").append("svg").attr("width", width).attr("height", height);
...
function drawTreeMap() {
    ...
    let svg = __WEBPACK_IMPORTED_MODULE_1_d3__["a" /* select */](".tree-map-modal").append("svg").attr("width", width + margin.left + margin.right).attr("height", height + margin.top + margin.bottom).append("g").attr("transform", "translate(" + margin.left + "," + margin.top + ")");

    const treemap = new __WEBPACK_IMPORTED_MODULE_4__treemap__["a" /* default */](svg, width, height);
    treemap.render();
}
...
/* harmony export (immutable) */ __webpack_exports__["a"] = showHeatMap;
